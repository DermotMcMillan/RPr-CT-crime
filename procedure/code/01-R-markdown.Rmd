...
There was no explicit research question. We will treat the results as exploratory and potentially do a spatial lag model to expand on the research. We also hope to caveat the results with qualitative context and offer some criticisms of predicting crime in general.
